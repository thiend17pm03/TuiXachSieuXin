    ...
    <div class="detailP">
                ...
                <div class="owl-wrapper-outer">
                    <div class="owl-wrapper" style="width: 712px; left: 0px; display: block; transition: all 1000ms ease; transform: translate3d(0px, 0px, 0px);">
                        <div class="owl-item" style="width: 356px;">
                            ...
                            $sanpham_res = mysqli_query($conn,$sanpham_query) ;
        ...
        <aside class="desProduct">
            ...
            <div class="pro_dg">
                ...
                <a target="_blank" href="#" class="fb shareFa"></a>
                <a target="_blank" href="#"></a>
                <a target="_blank" href="#" class="gg shareFa"></a>
            </div><!--end pro_dg-->
            <div class="proDha">
                <div class="btDah">
                ...
                <div class="yctv"><a href="https://fb.com/daylalinkfacecuathien" target="_blank"> YÊU CẦU TƯ VẤN</a> </div><!--end yctv-->
            </div><!--end proDha-->
            <div class="goituvan">
                <i class="icon"></i>GỌI TƯ VẤN
                <span>0978973382</span>
            </div><!--goiTongDa-->
            <?php  $id = $_GET["id"]?>
                    <a href='add-cart.php?id=<?php echo"$id" ?>'><div class='add_cart'><i></i>THÊM VÀO GIỎ </div></a>
        </aside><!--desProduct-->
        <aside class="ckProduct">
            <div class="titile">
                CAM KẾT KHI MUA HÀNG TẠI <span>HT SHOP</span>

            </div><!--titile-->
            <div class="deCk deCkTtct">
                <span class="icon"></span><!--end icon-->
                <span class="ttCK">Nhận hàng trong vòng <b>12 giờ</b> tại Bình Dương và <b>48 giờ</b> tại các tỉnh thành khác (Thanh toán Tiền mặt)</span><!--end ttCK-->
            </div><!--deCk deCkTtct-->
