...
<div id ="header">
    <div class ="topbar" style="background-color:#F4F4F4">
        <div class ="container">
            <div class="logo">
                <a href="<?php echo $base ?>">
                    ...
                    {
                        echo '<img src="./'.$logo_items['image_logo'].'" alt="'.$logo_items['name_logo'].'" tittle="'.$logo_items['name_logo'].'"/>';
                    }
                    ?>
                </a>
            </div><!--end logo-->
            <div class="search">
                <form class="searchform" action="<?php echo $base ?>/search.php" method="get">
                 <input class="s" placeholder="Tìm kiếm sản phẩm …" type="text" name="s" width="300px" />
                  <button class="searchsubmit" type="submit">
                </form>
            </div><!-----end search---->

            <div class="hotline" >
                <div class="ptittle" style="color:#2E3639">Hotline:</div><!--ptille-->
                <div class="pdetail" style="color:#2E3639">0978973382</div><!--pdetail-->
            </div>
            <!-- Đăng nhập -->
        </div><!--end container-->
    </div><!--End topbar--->
